<template>
    <div>
        <div class="tags p-8 hidden md:block">
        ...
        <div class="download-documents  md:p-8 mt-8 mb-8 md:mb-0">
            <div class="flex top-tags pb-3">
                <img src="@/assets/download.png" alt="">
                <h2>Descargar documentos</h2>
            </div>
            <div class="divider"></div>
            <div class="feature-box flex items-center  f1 py-4">
            ...
            <div class="flex top-tags pb-3 pt-8 f2">
                <img src="@/assets/build.png" alt="">
                <h2>See Partner Institutions</h2>
            </div>
            <div class="flex top-tags pb-3 pt-8 f3">
                <img src="@/assets/link.png" alt="">
                <h2>Quick Links</h2>
            </div>
            <div class="flex Quick-link items-center">
                <div class=" w-full md:w-2/4 flex flex-col justify-between h-full">
